...
f = open('xsections_hewettcheck.txt','r')
xsdict150={}
xsdict500={}
for line in f:
    s = line.split()
...
for lt in (2000,4000):
    ...
    sigfile150 = "hewettcheckplots_LambdaT%i_pTHat150-500.root"%(lt)
    sigfile500 = "hewettcheckplots_LambdaT%i_pTHat500-Inf.root"%(lt)
    bkgfile150 = "hewettcheckplots_LambdaT100000_pTHat150-500.root"
    bkgfile500 = "hewettcheckplots_LambdaT100000_pTHat500-Inf.root"
    ...
    # # pad1.SetLogy()
    c.cd(2)
    hsig.SetTitle("(#Lambda_{T}=%i) - SM Diphoton Background"%lt)
    ...
    c.SaveAs("hewettcheck_massplot_LambdaT%i.png"%(lt))
    # freg.Close()
    # finf.Close()