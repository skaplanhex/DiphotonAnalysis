...
for p in ("150-500","500-Inf"):
    ...
    eospath = '/eos/uscms/store/user/skaplan/noreplica/pythia8_SMffbar2GG/'
    shortpath = "/store/user/skaplan/noreplica/pythia8_SMffbar2GG/"
    ...
    fname = "Pythia8_SMffbar2GG_pTHat%s_cfi.py"%p
